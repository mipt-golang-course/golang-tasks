...
#### ВНИМАНИЕ – ЭТО ДОПОЛНИТЕЛЬНАЯ ЗАДАЧА. Выполнение по-желанию, на прием задач спринта не влияет
...
* Результаты ( список папок-файлов ) должны быть отсортированы по алфавиту. Т.е. у вас должен быть код который отсортирует уровень. Смотрите для этого пакет sort.
...
* Сигнатуру функции dirTree ( количество параметров ) менять нельзя
* Если вы столкнётесь с несовместимостью os.File и bytes.Buffer - смотрите ссылку на хабр ниже
