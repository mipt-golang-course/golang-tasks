...
//	num %= 1e9
//	if billions != 0 {
//		hundreds := billions / 100
//		if hundreds != 0 {
//			if first_word {
//				str += sep + dict[int(hundreds)]
//			} else {
//				str += dict[int(hundreds)]
//				first_word = true
//			}
//			str += sep + "hundred"
//		}
...
//		billions %= 100
//		if first_word {
//			str += sep + dict[int(billions)]
//		} else {
//			str += dict[int(billions)]
//			first_word = true
//		}
//		str += sep + "billion"
//	}
...
//			thousands %= 100
//			if first_word {
//				str += sep + dict[int(thousands)]
//			} else {
//				str += dict[int(thousands)]
//				first_word = true
//			}
//			str += sep + "thousand"
//		}
...
//		millions %= 100
//		if first_word {
//			str += sep + dict[int(millions)]
//		} else {
//			str += dict[int(millions)]
//			first_word = true
//		}
//
//		str += sep + "million"
